...
for prey in preys:
    ...
    df5 = pd.read_csv(input_dir + prey + '_MYO3_Myo5.dat', sep='\t')
...
df_pval.to_excel(stat_dir + 'figure_2F.xlsx', index=False, header=True)
...
plt.savefig(figure_dir + 'figure_2F.pdf', dpi=600, bbox_inches='tight')
plt.show()
