...
for prey in preys:
    ...
    df5 = pd.read_csv(input_dir + prey + '_MYO5_Myo3.dat', sep='\t')
...
df_pval.to_excel(stat_dir + 'figure_2E.xlsx', index=False, header=True)
...
plt.savefig(figure_dir + 'figure_2E.pdf', dpi=600, bbox_inches='tight')
plt.show()
