...
list_exps = ['Aim21_MYO3', 'Aim21_MYO35',
             'Bbc1_MYO3', 'Bbc1_MYO35',
             'Pan1_MYO3', 'Pan1_MYO35',
             'Osh2_MYO3', 'Osh2_MYO35',
             'Arc18_MYO3', 'Arc18_MYO35']
...
for exp1 in list_exps:
    for exp2 in list_exps:
        ...
        if exp1_list[-1] == 'MYO3':
            list_exp1.append('MYO3    Myo3    ' + exp1_list[0])
        else:
            list_exp1.append('MYO3    Myo5    ' + exp1_list[0])

        if exp2_list[-1] == 'MYO35':
            list_exp2.append('MYO3    Myo3    ' + exp2_list[0])
        else:
            list_exp2.append('MYO3    Myo5    ' + exp2_list[0])
