...
df1 = pd.read_csv(input_dir + 'MYO3_Bbc1.dat', sep='\t')
x = 26
y = 39
z = 56
...
ax.set_yticklabels(labels=['0.0', '-0.5', '-1.0', '-1.5'], weight='bold')
# for Osh2
# ax.set_yticks([1.0, 0.0, -1.0, -2.0, -3.0])
# ax.set_yticklabels(labels=['1.0', '0.0', '-1.0', '-2.0', '-3.0'], weight='bold')


ax.tick_params(axis='both', which='major', labelsize=fontsize, length=10, width=4, color=ax_color)
# ax.axhline(y=0.0, xmin=0.0, xmax=1.0, ls='--', color=ax_color, alpha=1, lw=2)
plt.show()
